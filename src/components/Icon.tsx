...
const paths: Record<IconName, React.ReactNode> = {
  ...
  palette: (
    <>
      <path d="M12 3a9 9 0 1 0 0 18c1.2 0 2-.9 2-2 0-1.3-1-1.8-1-3 0-.8.7-1.5 1.5-1.5H17a4 4 0 0 0 4-4c0-4.4-4-7.5-9-7.5z" />
  ...
  italic: <path d="M10 4h8M6 20h8M14 4l-8 16" />,
  underline: (
    <>
